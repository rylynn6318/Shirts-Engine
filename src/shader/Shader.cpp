...
se::Shader::Shader(const char *vertexPath, const char *fragmentPath)
{
...
auto se::Shader::checkCompileErrors(unsigned int shader, std::string type) -> void
{
    int success;
    char infoLog[1024];
    if (type != "PROGRAM")
